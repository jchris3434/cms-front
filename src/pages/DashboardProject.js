...
export default function DashboardProject({ isDarkMode }) {
  // Destructuring the useState calls symmetrically
  ...
  return (
    <div id={isDarkMode ? 'dashboardprojectdark' : ''}>
      ...
      <ContainerCustom displayStyle='dashboard' isDarkMode={isDarkMode}>
        <DashBoardCard
